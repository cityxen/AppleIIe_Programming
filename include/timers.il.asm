...
MAX_TIMERS   = 16
TIMER_FREQ   = 60       ; ticks per second (NTSC ~59.94 Hz)
...
; pause macros - wait until a specific timer fires
!macro pause1 { +IfTimerJmp TIMER_1, *-3 }
!macro pause2 { +IfTimerJmp TIMER_2, *-3 }
!macro pause3 { +IfTimerJmp TIMER_3, *-3 }
!macro pause4 { +IfTimerJmp TIMER_4, *-3 }
!macro pause5 { +IfTimerJmp TIMER_5, *-3 }
